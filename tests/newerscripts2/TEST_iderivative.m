...
% sinh
TEST_EQUAL(d_sinh_cs(-1),d_sinh(-1),[],'iderivative sinh, x₀ < 0');
TEST_EQUAL(d_sinh_cs(0),d_sinh(0),[],'iderivative sinh, x₀ = 0');
TEST_EQUAL(d_sinh_cs(1),d_sinh(1),[],'iderivative sinh, x₀ > 0');

% cosh
TEST_EQUAL(d_cosh_cs(-1),d_cosh(-1),[],'iderivative cosh, x₀ < 0');
TEST_EQUAL(d_cosh_cs(0),d_cosh(0),[],'iderivative cosh, x₀ = 0');
TEST_EQUAL(d_cosh_cs(1),d_cosh(1),[],'iderivative cosh, x₀ > 0');

% tanh
TEST_EQUAL(d_tanh_cs(-1),d_tanh(-1),[],'iderivative tanh, x₀ < 0');
TEST_EQUAL(d_tanh_cs(0),d_tanh(0),[],'iderivative tanh, x₀ = 0');
TEST_EQUAL(d_tanh_cs(1),d_tanh(1),[],'iderivative tanh, x₀ > 0');

% csch
TEST_EQUAL(d_csch_cs(-1),d_csch(-1),[],'iderivative csch, x₀ < 0');
TEST_EQUAL(d_csch_cs(0),d_csch(0),[],'iderivative csch, x₀ = 0');
TEST_EQUAL(d_csch_cs(1),d_csch(1),[],'iderivative csch, x₀ > 0');

% sech
TEST_EQUAL(d_sech_cs(-1),d_sech(-1),[],'iderivative sech, x₀ < 0');
TEST_EQUAL(d_sech_cs(0),d_sech(0),[],'iderivative sech, x₀ = 0');
TEST_EQUAL(d_sech_cs(1),d_sech(1),[],'iderivative sech, x₀ > 0');
...
% asinh
TEST_EQUAL(d_asinh_cs(-1.5),d_asinh(-1.5),[],'iderivative asinh, x₀ < -1');
TEST_EQUAL(d_asinh_cs(-1),d_asinh(-1),[],'iderivative asinh, x₀ = -1');
TEST_EQUAL(d_asinh_cs(-0.5),d_asinh(-0.5),[],'iderivative asinh, -1 < x₀ < 0');
TEST_EQUAL(d_asinh_cs(0),d_asinh(0),[],'iderivative asinh, x₀ = 0');
TEST_EQUAL(d_asinh_cs(0.5),d_asinh(0.5),[],'iderivative asinh, 0 < x₀ < 1');
TEST_EQUAL(d_asinh_cs(1),d_asinh(1),[],'iderivative asinh, x₀ = 1');
TEST_EQUAL(d_asinh_cs(1.5),d_asinh(1.5),[],'iderivative asinh, x₀ > 1');

% acosh
TEST_EQUAL(d_acosh_cs(-1.5),d_acosh(-1.5),[],'iderivative acosh, x₀ < -1');
TEST_EQUAL(d_acosh_cs(-1),d_acosh(-1),[],'iderivative acosh, x₀ = -1');
TEST_EQUAL(d_acosh_cs(-0.5),d_acosh(-0.5),[],'iderivative acosh, -1 < x₀ < 0');
TEST_EQUAL(d_acosh_cs(0),d_acosh(0),[],'iderivative acosh, x₀ = 0');
TEST_EQUAL(d_acosh_cs(0.5),d_acosh(0.5),[],'iderivative acosh, 0 < x₀ < 1');
TEST_EQUAL(d_acosh_cs(1),d_acosh(1),[],'iderivative acosh, x₀ = 1');
TEST_EQUAL(d_acosh_cs(1.5),d_acosh(1.5),[],'iderivative acosh, x₀ > 1');

% atanh
TEST_EQUAL(d_atanh_cs(-1.5),d_atanh(-1.5),[],'iderivative atanh, x₀ < -1');
TEST_EQUAL(d_atanh_cs(-1),d_atanh(-1),[],'iderivative atanh, x₀ = -1');
TEST_EQUAL(d_atanh_cs(-0.5),d_atanh(-0.5),[],'iderivative atanh, -1 < x₀ < 0');
TEST_EQUAL(d_atanh_cs(0),d_atanh(0),[],'iderivative atanh, x₀ = 0');
TEST_EQUAL(d_atanh_cs(0.5),d_atanh(0.5),[],'iderivative atanh, 0 < x₀ < 1');
TEST_EQUAL(d_atanh_cs(1),d_atanh(1),[],'iderivative atanh, x₀ = 1');
TEST_EQUAL(d_atanh_cs(1.5),d_atanh(1.5),[],'iderivative atanh, x₀ > 1');

% acsch
TEST_EQUAL(d_acsch_cs(-1.5),d_acsch(-1.5),[],'iderivative acsch, x₀ < -1');
TEST_EQUAL(d_acsch_cs(-1),d_acsch(-1),[],'iderivative acsch, x₀ = -1');
TEST_EQUAL(d_acsch_cs(-0.5),d_acsch(-0.5),[],'iderivative acsch, -1 < x₀ < 0');
TEST_EQUAL(d_acsch_cs(0),d_acsch(0),[],'iderivative acsch, x₀ = 0');
TEST_EQUAL(d_acsch_cs(0.5),d_acsch(0.5),[],'iderivative acsch, 0 < x₀ < 1');
TEST_EQUAL(d_acsch_cs(1),d_acsch(1),[],'iderivative acsch, x₀ = 1');
TEST_EQUAL(d_acsch_cs(1.5),d_acsch(1.5),[],'iderivative acsch, x₀ > 1');

% asech
TEST_EQUAL(d_asech_cs(-1.5),d_asech(-1.5),[],'iderivative asech, x₀ < -1');
TEST_EQUAL(d_asech_cs(-1),d_asech(-1),[],'iderivative asech, x₀ = -1');
TEST_EQUAL(d_asech_cs(-0.5),d_asech(-0.5),[],'iderivative asech, -1 < x₀ < 0');
TEST_EQUAL(d_asech_cs(0),d_asech(0),[],'iderivative asech, x₀ = 0');
TEST_EQUAL(d_asech_cs(0.5),d_asech(0.5),[],'iderivative asech, 0 < x₀ < 1');
TEST_EQUAL(d_asech_cs(1),d_asech(1),[],'iderivative asech, x₀ = 1');
TEST_EQUAL(d_asech_cs(1.5),d_asech(1.5),[],'iderivative asech, x₀ > 1');

% acoth
TEST_EQUAL(d_acoth_cs(-1.5),d_acoth(-1.5),[],'iderivative acoth, x₀ < -1');
TEST_EQUAL(d_acoth_cs(-1),d_acoth(-1),[],'iderivative acoth, x₀ = -1');
TEST_EQUAL(d_acoth_cs(-0.5),d_acoth(-0.5),[],'iderivative acoth, -1 < x₀ < 0');
TEST_EQUAL(d_acoth_cs(0),d_acoth(0),[],'iderivative acoth, x₀ = 0');
TEST_EQUAL(d_acoth_cs(0.5),d_acoth(0.5),[],'iderivative acoth, 0 < x₀ < 1');
TEST_EQUAL(d_acoth_cs(1),d_acoth(1),[],'iderivative acoth, x₀ = 1');
TEST_EQUAL(d_acoth_cs(1.5),d_acoth(1.5),[],'iderivative acoth, x₀ > 1');