%% |ijacobian|
% Jacobian matrix of a vector-valued function using the complex-step 
% approximation.
% 
...
%           <td><TT>f</TT></td>
%           <td>vector-valued function (<img src="https://latex.codecogs.com/svg.latex?\inline&space;\mathbf{f}:\mathbb{R}^{n}\rightarrow\mathbb{R}^{m}" title="" />)</td>
