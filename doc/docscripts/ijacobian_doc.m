...
%           <td style="text-align:center"><img src="https://latex.codecogs.com/svg.latex?\inline&space;\mathbf{J}(\mathbf{x}_{0})" title="" /></td>
%           <td><TT>J</TT></td>
...
%
% _at $\mathbf{x}=\mathbf{x}_{0}=(5,6,7)^{T}$ using the |ijacobian| 
